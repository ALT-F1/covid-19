# -*- coding: utf-8 -*-
"""daily_geographic_distribution_of_covid-19_cases_worldwide-v0.0.7.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1X6lSPpBi-SKuR0kA9mLET5aFwDi4am8c
...
# Press CTRL+F9 (Runtime > Run all in the menu) to execute the notebook

> Edit the line below with the countries you would like to analyze
"""

countries = ['China', 'Morocco', 'Belgium', 'Spain', 'France', 'Italy', 'United_States_of_America']

"""> Execute the notebook (CTRL-F9)

> Scroll down until the charts
"""
  ...
  for country in countries:
    ...
    data.append(
        go.Bar(
          ...
          x=df[df['countriesAndTerritories']==country][bar_x],
          y=df[df['countriesAndTerritories']==country][bar_y]
        )
      )
  # plot titles and axis labels
  layout = go.Layout(
...
df[df['countriesAndTerritories']=="China"].head(2)
